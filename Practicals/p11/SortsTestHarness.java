...
class SortsTestHarness 
{
    ...
    private static void usage() 
    {
        ...
        System.out.println("           c - counting sort");
        System.out.println("           h - shell sort");
        System.out.println("           i - insertion sort");
        System.out.println("           l - radix LSD sort");
        System.out.println("           m - mergesort");
        System.out.println("           q - quicksort leftmost pivot");
        System.out.println("           s - selection sort");
        System.out.println("           y - 3 Way quicksort");
        System.out.println("           z - quicksort 3-median pivot");
        ...
        System.out.println("           R - repeating values");
    }
...
//                    long startTime = System.currentTimeMillis();
                    ...
                    switch (sortType)
                    {
                        ...
                        case 'l' : Sorts.radixSort(A); break;
                        case 'm' : Sorts.mergeSort(A); break;
                        case 'q' : Sorts.quickSort(A); break;
                        case 's' : Sorts.selectionSort(A); break;
                        case 'y' : Sorts.threeWayQuickSort(A); break;
                        case 'z' : Sorts.QuickSortMedian3(A); break;
